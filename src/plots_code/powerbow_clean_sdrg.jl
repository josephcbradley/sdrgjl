...
#α = 0.1
    ...
    powerbow = PowerbowDistribution(BigFloat(0.0), BigFloat(α))
    ...
    @df disd scatter!(fig_4, :l, :entropy, label = "α = $α")
...
saveplot(fig_4, img_path, "powerbow_entropy_clean")